/**
 * A preview of what a board actually looks like ridden.
 *
 ...
 * costs nothing, stays sharp at any size, and re-colours from the same five
 * skin values the 3D model uses, so a board reads the same here as in play.
 *
...
export function BoardPreview({ skin, size = 56 }: BoardPreviewProps) {
  ...
  return (
    ...
    >
      ...
      {/* Scarf, trailing back and out - the same read as the 3D model. */}
      <path
        d="M44 27 q11 1 16 7 q-6 1 -9 -1 q-3 3 -8 2 z"
        fill={board}
      />
      ...
      */}
      ...
      <rect x="22" y="15" width="28" height="6" rx="3" fill={boardTrim} />
